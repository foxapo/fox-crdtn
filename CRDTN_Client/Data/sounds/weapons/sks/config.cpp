...
class CfgSoundShaders
{
	...
	class SKS_closeShot_SoundShader: closeShotRifle_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_close",
				1
			}
		};
		volume=1;
	...
	class SKS_midShot_SoundShader: midShotRifle_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_distant",
				1
			}
		};
		volume=1.1220185;
	...
	class SKS_distShot_SoundShader: distShotRifle_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_far",
				1
			}
		};
		volume=1.1220185;
	...
	class SKS_tailInterior_SoundShader: tailInteriorRifle_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_indoor_distant",
				1
			}
		};
	};
	...
	class SKS_silencerHomeMadeCloseShot_SoundShader: base_HomeSilenced_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_silenced_close",
				1
			}
		};
	};
	...
	class SKS_silencerHomeMadeTailInterior_SoundShader: base_HomeSilenced_tailInterior_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_fire_indoor_silenced_distant",
				1
			}
		};
	};
	class SKS_charge_open_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_slider_up2",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_charge_open_release_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_slider_up",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_charge_close_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_slider_catch",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_charge_close_release_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_slider_down",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_chamber_load_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_round_load1",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_round_load2",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_round_load3",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_round_load4",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_round_load5",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_hand2_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_hand1",
				1
			}
		};
		volume=0.79432821;
	...
	class SKS_hand3_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\sks\sks_hand2",
				1
			}
		};
		volume=0.79432821;
