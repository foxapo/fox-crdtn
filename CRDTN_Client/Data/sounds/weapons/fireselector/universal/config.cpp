...
class CfgSoundShaders
{
	class weap_fireselector_uni_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\fireselector\universal\weap_fireselctor",
				1
			}
		};
		volume=0.31622776;
	...
	class kedr_fireselector_up_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\fireselector\universal\kedr_fireselector_up",
				1
			}
		};
		volume=0.31622776;
	...
	class kedr_fireselector_down_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\fireselector\universal\kedr_fireselector_down",
				1
			}
		};
		volume=0.31622776;
