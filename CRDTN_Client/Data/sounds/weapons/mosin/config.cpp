...
class CfgSoundShaders
{
	class Mosin_closeShot_SoundShader: base_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_outdoor_close1",
				1
			}
		};
		volume=1.1220185;
	...
	class Mosin_midShot_SoundShader: base_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_outdoor_distant1",
				1
			}
		};
		volume=0.70794576;
	...
	class Mosin_distShot_SoundShader: base_distShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_outdoor_far1",
				1
			}
		};
		volume=0.70794576;
	...
	class Mosin_charge_open_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_bolt_na_tebya",
				1
			}
		};
		volume=0.79432821;
	...
	class Mosin_charge_close_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mosin\mosin_bolt_ot_tebya",
				1
			}
		};
		volume=0.79432821;
