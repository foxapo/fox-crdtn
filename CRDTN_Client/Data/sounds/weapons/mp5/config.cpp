...
class CfgSoundShaders
{
	...
	class MP5K_closeShot_SoundShader: closeShotSMG_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_outdoor_close_1",
				1
			}
		};
		volume=1;
	...
	class MP5K_tailDistant_SoundShader: tailDistantSMG_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_outdoor_close_tail",
				1
			}
		};
		volume=2.5118864;
	...
	class MP5K_tailInterior_SoundShader: tailInteriorSMG_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_indoor_close_tail",
				1
			}
		};
	};
	...
	class MP5K_silencerCloseShot_SoundShader: base_ProfessionalSilenced_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_outdoor_close_silenced_1",
				1
			}
		};
	};
	...
	class MP5K_silencerTailForest_SoundShader: base_ProfessionalSilenced_tailForest_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_outdoor_silenced_tail",
				1
			}
		};
	};
	...
	class MP5K_silencerTailInterior_SoundShader: base_ProfessionalSilenced_tailInterior_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_indoor_silenced_tail",
				1
			}
		};
	};
	...
	class MP5K_charge_open_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_bolt_out",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_charge_open_release_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_bolt_out_handle",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_charge_close_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_bolt_in",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_charge_close_release_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_bolt_in_slap",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_mag_in_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_mag_release_button",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_mag_load_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_mag_in",
				1
			}
		};
		volume=0.79432821;
	...
	class MP5K_mag_remove_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\mp5\mp5_weap_mag_out",
				1
			}
		};
		volume=0.79432821;
