...
class CfgSoundShaders
{
	...
	class SVD_closeShot_SoundShader: base_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_fire_close",
				1
			}
		};
		volume=0.79432821;
	...
	class SVD_midShot_SoundShader: base_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_fire_distant",
				1
			}
		};
		volume=0.79432821;
	...
	class SVD_distShot_SoundShader: base_distShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_fire_far",
				1
			}
		};
		volume=0.79432821;
	...
	class SVD_charge_open_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_slider_in",
				1
			}
		};
		volume=0.56234133;
	...
	class SVD_charge_close_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_slider_out",
				1
			}
		};
		volume=0.56234133;
	...
	class SVD_mag_in_SoundShader: reloadWeaponINT_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_mag_button",
				1
			}
		};
	};
	class SVD_mag_load_SoundShader: reloadWeaponINT_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_mag_in_faster_for_check",
				1
			}
		};
	};
	...
	class SVD_mag_remove_SoundShader: reloadWeaponINT_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\weapons\svd\svd_mag_out",
				1
			}
		};
	};
