...
class CfgSoundShaders
{
	class ShoulderL_Hide_Rifle_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\holding\weapon\takeout\weap_out",
				1
			}
		};
		volume=0.40000001;
	...
	class ShoulderL_Show_Rifle_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\holding\weapon\takeout\weap_in",
				1
			}
		};
		volume=0.5;
