...
class CfgSoundShaders
{
	class runErc_asphalt_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_01",
				1
			},
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_03",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_04",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_05",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_06",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_07",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_08",
				1
			}
		};
		volume="boots * 0.3";
	...
	class runErc_asphalt_ext_sneakers_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_asphalt_02",
				1
			},
	...
	class runErc_concrete_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete1",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete2",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete3",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete4",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete5",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_concrete6",
				1
			}
		};
		volume="boots * 0.38";
	...
	class runErc_dirt_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_01",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_02",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_03",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_04",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_05",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_06",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_07",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\soil_run_08",
				1
			}
		};
		volume="boots * 0.35";
	...
	class runErc_gravel_small_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_01",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_02",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_03",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_04",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_05",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_06",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_07",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_gravel_08",
				1
			}
		};
		volume="boots * 0.2";
	...
	class runErc_wood_parquet_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_01",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_02",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_03",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_04",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_05",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_06",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_07",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_08",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_09",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_wood_10",
				1
			}
		};
		volume="boots * 0.4";
	...
	class runErc_metal_thick_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal1",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal2",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal3",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal4",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal5",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_metal6",
				1
			}
		};
		volume="boots * 0.4";
	...
	class runErc_metal_thin_ext_boots_shoes_runErc_Char_SoundShader: baseCharacter_SoundShader
	{
		samples[]=
		{
			...
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_01",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_02",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_03",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_04",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_05",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_06",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_07",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_08",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_09",
				1
			},
			
			{
				"CRDTN_Client\Data\sounds\environment\player\movement\run\run_proflist_10",
				1
			}
		};
		volume="boots * 0.4";
